...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 API 文档</h1>
            <p class="subtitle">官方网站后台系统 RESTful API 接口文档</p>
            ...
            <div class="endpoint">
                <div class="endpoint-header">
                    <div class="endpoint-info">
                        ...
                        <div class="endpoint-url" id="url-health">' . $baseUrl . 'health</div>
                        <div>
                ...
                <div class="endpoint-body">
                    <p class="description"><strong>功能描述:</strong> 检查 API 服务是否正常运行，返回系统状态信息。</p>
            ...
            <div class="endpoint">
                <div class="endpoint-header">
                    <div class="endpoint-info">
                        ...
                        <div class="endpoint-url" id="url-test">' . $baseUrl . 'test</div>
                        <div>
                            <span class="method-badge method-get">GET</span>
                        </div>
                    </div>
                ...
                <div class="endpoint-body">
                    <p class="description"><strong>功能描述:</strong> 简单的测试接口，用于验证 API 连接性和基本功能。</p>
                    <div class="response-info">
            ...
            <div class="endpoint">
                <div class="endpoint-header">
                    <div class="endpoint-info">
                        ...
                        <div class="endpoint-url" id="url-info">' . $baseUrl . 'info</div>
                        <div>
                            <span class="method-badge method-get">GET</span>
                        </div>
                    </div>
                ...
                <div class="endpoint-body">
                    <p class="description"><strong>功能描述:</strong> 获取 API 系统的基本信息，包括版本、描述和所有可用端点列表。</p>
                    <div class="response-info">
            ...
            <div class="endpoint">
                <div class="endpoint-header">
                    <div class="endpoint-info">
                        ...
                        <div class="endpoint-url" id="url-news">' . $baseUrl . 'news</div>
                        <div>
                            <span class="method-badge method-get">GET</span>
                ...
                <div class="endpoint-body">
                    <p class="description"><strong>功能描述:</strong> 新闻文章管理接口，支持获取新闻列表和创建新文章。</p>
                    <div class="response-info">
...
switch ($path) {
    ...
    case '/info':
        ...
        send_json([
            ...
            'name' => '官方网站后台API',
            'version' => '3.0.0',
            'description' => '提供新闻文章管理、用户认证等功能的RESTful API服务',
            'base_url' => $baseUrl,
            'endpoints' => [
                [
                    'name' => '健康检查',

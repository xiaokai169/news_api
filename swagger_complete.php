...
// 如果是根路径，显示 Swagger UI
if ($path === '/' || $path === '/swagger_complete.php') {
    echo '<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="header">
        <h1>🚀 官方网站后台 API 文档</h1>
        <p>RESTful API 接口文档和测试工具 - 完全独立版本</p>
    </div>
    <div class="container">
        <div class="info-box">
            <h3>📖 使用说明</h3>
    ...
    <script>
        ...
        async function testAPI() {
            ...
            try {
                const response = await fetch("' . $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/api/health");
                ...
                resultDiv.innerHTML = "❌ API 连接失败！<br>错误: " + error.message + "<br><br>请确保：<br>1. 使用正确的启动命令<br>2. 服务器正在运行在正确端口<br>3. 防火墙没有阻止访问";
